...
func TestSlotToEpochMainnetExtended(t *testing.T) {
	tests := []struct {
		...
		{4492800 + 432000*10, 218},  // 10 Shelley epochs
...
// ============================================================================
// Nonce Functions — Manual Verification (merged from nonce_test.go)
// ============================================================================
...
// ============================================================================
// Store Operations — Unit Tests (merged from store_test.go)
// ============================================================================
